...
<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Add New Subcategory</h1>
            ...
            <div class="col-xl-12">
                <div class="card card-flush h-lg-100" id="kt_contacts_main">
                    ...
                    <div class="card-body pt-5">
                        ...
                        <form id="subcategoryForm" class="form" method="POST" action="{{ route('admin.subcategories.store') }}">
                            @csrf
...
$(document).ready(function () {
    ...
    $('#subcategoryForm').validate({
        ...
        messages: {
            name: { required: "Enter Subcategory Name", minlength: "Minimum 3 characters" },
