            ...
            <div class="header-to-main d-none d-sm-flex">
               ...
               <div class="tp-header-top-menu d-flex align-items-center justify-content-end">
                  ...
                  <div class="header-lang-item tp-header-currency">
                     <a href="{{ route('user.login') }}" style="color: white;">User Login<a/>
                     <!--<ul>
                        <li>
                  ...
                  <div class="header-lang-item tp-header-setting">
                     <span class="header-setting-toggle grocery-clr-hover" id="header-setting-toggle" ><a href="" >Language<a/></span>
                     <ul>
                        <li>
               ...
               <div class="header-main-4">
                  <div class="header-left">
                     <div class="header-logo">
                        <a href="grocery.html">
                           <img src="{{ asset('frontend-assets/imgs/grocery/logo/logo.svg') }}" alt="logo not found">
                        </a>
                     </div>
