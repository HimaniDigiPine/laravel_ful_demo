            ...
            <div class="footer-grid-3">
               <div class="footer-widget-4">
                  <div class="footer-logo mb-35">
                     <a href="grocery.html"><img src="{{ asset('frontend-assets/imgs/grocery/logo/logo-light.svg') }}"
            ...
            <div class="footer-payment d-flex align-items-center gap-2">
               <div class="footer-payment-item mb-0">
                  <div class="footer-payment-thumb">
                     <img src="{{ asset('frontend-assets/imgs/icons/payoneer.png') }}" alt="">
                  </div>
               </div>
               <div class="footer-payment-item mb-0">
                  <div class="footer-payment-thumb">
                     <img src="{{ asset('frontend-assets/imgs/icons/maser.png') }}" alt="">
                  </div>
               </div>
               <div class="footer-payment-item">
                  <div class="footer-payment-thumb">
                     <img src="{{ asset('frontend-assets/imgs/icons/paypal.png') }}" alt="">
                  </div>
               </div>
            </div>
